<template>
    <div>
        <a
            ...
            class="fixed cursor-pointer mb-2 z-50 bottom-5 right-5 animate-bounce inline-block rounded-full p-3 text-xs font-medium uppercase leading-normal text-white shadow-md transition duration-150 ease-in-out hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg"
...
<script>
import HeroSection from "@/Components/WebGenieComponents/HeroSection.vue";
import About from "@/Components/WebGenieComponents/About.vue";
